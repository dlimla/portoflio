            ...
            <div className="inq_main_con">
                ...
                <div className= "inq_inner_con">
                    ...
                    <div className="div_border">
                        <h2 className="inq_title">INQUIRY</h2>
                        <div className="inq_links">
                    ...
                    <div className="section_div">
                        ...
                        <div className="img_div">
                            <img src={splash} alt="Smiley face" height="242" width="442"/>
                            <img src={splash2} alt="Smiley face" height="242" width="442"/>
                        </div>
                    </div>
                    ...
                    <div>
                        <h4 className="features">Features</h4>
                            <div className="section_div">
                                ...
                                <div className="img_div">
                                    <img src={UserCalander} alt="Smiley face" height="242" width="442"/>
                                    <img src={ContrCalander} alt="Smiley face" height="242" width="442"/>
                                </div>
                            </div>
                            ...
                            <div className="img_div">
                                <img src={userFeed} alt="Smiley face" height="242" width="442"/>
                                <img src={contrFeed} alt="Smiley face" height="242" width="442"/>
                            </div>
                            ...
                            <div className="img_div">
                                <img src={member1} alt="Smiley face" height="242" width="442"/>
                                <img src={member2} alt="Smiley face" height="242" width="442"/>
                            </div>
